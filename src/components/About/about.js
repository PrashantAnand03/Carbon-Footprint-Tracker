                ...
                <div className="aboutContainer">
                    <div className='aboutVideo'>
                        {isVideoLoaded ? (
                            <iframe
                                width="700"
                                height="400"
                                src="https://www.youtube.com/embed/qaqRgdqGD2o?start=41"
                            ...
                            <div className="dynamic-background" onClick={() => setIsVideoLoaded(true)}>
                                <div
                                    style={{ width: '700px', height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                                >
                                    <a 
                                        href="#" 
                                        className="load-video-link" 
                                        onClick={(e) => { e.preventDefault(); setIsVideoLoaded(true); }}>
                    ...
                    <div className='aboutWrap'>
                        <div className='aboutContent'>
                            ...
                            <p>
                                <span>Technology based energy savings.</span><br />
                                ...
                                travel more carbon footprint friendly<br />
                                ...
                                <br />
                                <span>ELECTRIC VEHICLES</span><br />
                        ...
                        <div className='image1'>
                            <img src={img1} alt='' height={400} width={400} loading="lazy" />
                        </div>
                    </div>

                    <div className='aboutWrap'>
                        <div className='image1'>
                            <img src={img2} alt='' height={300} width={400} loading="lazy" />
                        </div>
                        <div className='aboutContent'>
                    ...
                    <div className='aboutWrap'>
                        <div className='aboutContent'>
                            ...
                            <p>
                                ...
                                5. Shorten shower time and turn off electrical devices when not in use. These actions can help reduce carbon 
                                emissions and contribute to combating climate change together.<br />
                            </p>
                        </div>
                        <div className='image1'>
                            <img src={img3} alt='' height={250} width={400} loading="lazy" />
                        </div>
                    </div>
                </div>
            </div>
